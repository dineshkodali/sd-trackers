...
> **Note**: For the full architecture blueprint and setup guides, see [`docs/ios.md`](./docs/ios.md).
...
2. **100% Brand Kit Parity**: Uses the exact same design language from [`docs/BRAND_KIT.md`](./docs/BRAND_KIT.md) (Teal `#0d9488`, Fluent neutral surfaces `#f3f2f1` / `#faf9f8`, sharp 2px radii, high-density enterprise typography, and consistent badge colors).
...
The iOS app strictly implements the design tokens from [`docs/BRAND_KIT.md`](./docs/BRAND_KIT.md):
