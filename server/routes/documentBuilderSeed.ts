/**
 * Document Builder — Seed Templates
 *
 * Three default templates available immediately without database seeding.
 * These are used as fallbacks when Supabase tables are not yet migrated.
 */
