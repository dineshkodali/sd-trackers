...
const { migrateLegacyLocalData, hasLegacyLocalData } = await import('../../../src/services/legacyLocalDataMigration.ts');
const { INITIAL_PUBLIC_TRANSPORT_RECORDS, INITIAL_BOOKLET_RECORDS, INITIAL_ROLE_PERMISSIONS } = await import('../../../src/data/initialData.ts');
